  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-50">
      <button
        ...
        onClick={onClose}
        className="absolute inset-0 pointer-events-auto bg-neutral/42 opacity-100 backdrop-blur-sm"
      />
      ...
      <aside
        ...
        className="pointer-events-auto absolute right-0 top-0 flex h-dvh w-full max-w-none flex-col bg-base-100/95 shadow-2xl shadow-neutral/25 backdrop-blur-xl transition-transform duration-300 ease-out sm:max-w-md sm:rounded-l-4xl sm:border-l sm:border-base-300/70"
      >
